...
@Component({
  ...
  standalone:true,
  styleUrls: ['./laptop.component.css','./app.component.css','./product.component.css'],
  template:`

      <div class="card-list p-3 mb-2 bg-light text-dark">

  <app-product *ngFor="let productdata of LaptopDataList let i=index" [productdata]="productdata"   (removeItem)="RemoveItem(i)">
  </app-product>
...
export class LaptopsComponent {
  RemoveItem(index:number):void{
    this.LaptopDataList.splice(index,1);
  }
  ...
  LaptopDataList:ProductData[]=[

    {
      ...
      photo: 'https://resources.cdn-kaspi.kz/img/m/p/hf4/h52/64509322919966.jpg?format=preview-large',
